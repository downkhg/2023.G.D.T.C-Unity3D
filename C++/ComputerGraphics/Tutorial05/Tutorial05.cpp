...
void Render()
{
    ...
    XMMATRIX matS = mScale;
    XMMATRIX matR = mSpin * mOrbit;
    XMMATRIX matT = mTranslate;

    //XMMATRIX matTrans = matS * matR * matT;
    //XMMATRIX matTrans = matS * matT * matR;
    XMMATRIX matTrans = matR * matT * matS;

    g_World2 = matTrans;// *g_World1;
	//g_World2 = mScale  * mTranslate * mSpin * mOrbit;
