...
LRESULT CALLBACK WindowsProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        _cprintf("WM_CREATE:\n");
        CreateWindow(TEXT("Button"), TEXT("Click me"), WS_CHILD | WS_VISIBLE | BS_DEFPUSHBUTTON, 300, 300, 100, 25, hWnd, (HMENU)PUSHBTN, hInst, NULL);
        break;
    case WM_COMMAND:
        {
            ...
            {
            case PUSHBTN:
                MessageBox(hWnd, TEXT("First Button Clicked"), TEXT("Button"), MB_OKCANCEL);
                break;
            case IDM_ABOUT:
