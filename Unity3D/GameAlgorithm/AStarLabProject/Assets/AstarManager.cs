...
public class AstarManager : MonoBehaviour
{
    ...
    public void PathFinding()
    {
        ...
        startPos.x = (int)trPos.position.x;
        startPos.y = (int)trPos.position.y;

        targetPos.x = (int)trTarget.position.x;
        targetPos.y = (int)trTarget.position.y;
    ...
    void OnDrawGizmos()
    {
        if (FinalNodeList.Count != 0)
            for (int i = 0; i < FinalNodeList.Count - 1; i++)
            {
                ...
                Vector3 vStart = new Vector3(FinalNodeList[i].x, FinalNodeList[i].y);
                Vector3 vEnd = new Vector3(FinalNodeList[i + 1].x, FinalNodeList[i + 1].y);
